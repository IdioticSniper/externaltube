...
<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
	<tr valign=\"top\">
		...
		<div class=\"moduleFrameDetails\">Added: " . $Now->format('F') . " " . $Now->format('d') . ", " . $Now->format('Y') . "<br>by <a href=\"/profile_videos.php?user=" . $video->uploaded_by . "\" target=\"_parent\">" . $video->uploaded_by . "</a></div>
		</td>
	</tr>
</table>
</div>
