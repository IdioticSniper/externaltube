...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr valign="top">
		<td width="130" rowspan="2" style="padding: 0px 5px 5px 5px;"><a href="index.php"><img src="img/exttube.png" width="120" height="48" alt="ExternalTube" border="0"></a></td>
		<td valign="top">
		
		<table width="670" cellpadding="0" cellspacing="0" border="0">
			<tr valign="top">
				<td style="padding: 0px 5px 0px 5px; font-style: italic;">Browse through videos from the depths of the virtual vault!</td>
				<td align="right">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
					
				<td><a href="#" class="bold">Sign Up</a></td>
				<td>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
				<td><a href="#">Log In</a></td>
				<td>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
				<td style="padding-right: 5px;"><a href="#">Help</a></td>
		...
		<div style="font-size: 12px; font-weight: bold; float: right; padding: 10px 5px 0px 5px;"><a href="#">Upload</a> &nbsp;//&nbsp; <a href="browse.php">Browse</a> &nbsp;//&nbsp; <a href="#">Invite</a></div>
